...
public class TFontRenderer extends SnowstormFont {

    SnowstormFont.CharData[] boldChars = new SnowstormFont.CharData[256],
            italicChars = new SnowstormFont.CharData[256],
            boldItalicChars = new SnowstormFont.CharData[256];
    int[] colorCode = new int[32];
    DynamicTexture texBold, texItalic, texItalicBold;
    String colorcodeIdentifiers = "0123456789abcdefklmnor";

    public TFontRenderer(Font font) {
        super(font, true, true);
        this.setupMinecraftColorcodes();
        //this.setupBoldItalicIDs();
    }

    public TFontRenderer(Font font, boolean antiAlias, boolean fractionalMetrics) {
    ...
    public float drawString(String text, double x, double y, int color, boolean shadow, float kerning, boolean smooth) {
        ...
        SnowstormFont.CharData[] currentData = this.charData;
        ...
        for (int index = 0; index < text.length(); index++) {
            ...
            if (character == '§') {
                ...
                if (colorIndex < 16) {
                    ...
                    RenderUtils.setColor(this.colorCode[colorIndex]);
                } else {
                    switch (colorIndex) {
                        case 17:
                            bold = true;
