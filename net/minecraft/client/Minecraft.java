...
import today.snowstorm.api.ui.SplashScreen;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private static final ResourceLocation locationMojangPng = new ResourceLocation("Snowstorm/images/black.jpg");
    ...
    public Minecraft(GameConfiguration gameConfig)
    {
        ...
        logger.info("[Snowstorm PROTECT] We have prevented your sessionID from being posted here.");
    ...
    private void startGame() throws LWJGLException, IOException
    {
        ...
        //this.fontRendererObj = new SnowstormFontRenderer(FontUtil.getFont(getResourceManager().getResource(new ResourceLocation("Snowstorm/fonts/Poppins-Regular.ttf")).getInputStream()));

        //FontUtil.poppinsRegular = FontUtil.getFont();

        Map<String, Font> locationMap = new HashMap<>();
        FontUtil.poppinsFat722 = FontUtil.getFont(locationMap, "Poppins-Black.ttf", 42);
        FontUtil.poppinsFat72 = new TFontRenderer(FontUtil.poppinsFat722);

        FontUtil.poppinsFat242 = FontUtil.getFont(locationMap, "Poppins-Black.ttf", 24);
        FontUtil.poppinsFat24 = new TFontRenderer(FontUtil.poppinsFat242);

        FontUtil.poppinsNormal242 = FontUtil.getFont(locationMap, "Poppins-Regular.ttf", 24);
        FontUtil.poppinsNormal24 = new TFontRenderer(FontUtil.poppinsNormal242);

        FontUtil.poppinsNormal182 = FontUtil.getFont(locationMap, "Poppins-Regular.ttf", 18);
        FontUtil.poppinsNormal18 = new TFontRenderer(FontUtil.poppinsNormal182);

        FontUtil.poppinsNormal162 = FontUtil.getFont(locationMap, "Poppins-Regular.ttf", 16);
        FontUtil.poppinsNormal16 = new TFontRenderer(FontUtil.poppinsNormal162);

        //try {
        //    FontUtil.SnowstormFont = FontUtil.getFont("Poppins-Regular.ttf");
        ...
        else
        {
            ...
            this.displayGuiScreen(new SplashScreen());
    ...
    private void updateFramebufferSize()
    {
        ...
        Blur.onFrameBufferResize(this.displayWidth, this.displayHeight);
    }
    ...
    public void runTick() throws IOException
    {
        ...
        Snowstorm.INSTANCE.getEventBus().register(e);
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput)
        {
            ...
            while (Keyboard.next())
            {
                ...
                if (Keyboard.getEventKeyState())
                {
                    ...
                    {
                        KeyEvent ev = new KeyEvent(k);
                        Snowstorm.INSTANCE.getEventBus().call(ev);
        ...
        Snowstorm.INSTANCE.getEventBus().call(e);
        if(!e.isCancelled()) return;
