...
public abstract class GuiContainer extends GuiScreen
{
    ...
    private DecelerateAnimation decelerateAnimation;

    public void initGui()
    {
        super.initGui();

        decelerateAnimation = new DecelerateAnimation(150, 1.0f);
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        Blur.blurArea(0, 0, sr.getScaledWidth(), sr.getScaledHeight());
        RenderUtils.scale(sr.getScaledWidth() / 2f, sr.getScaledHeight() / 2f, (float) decelerateAnimation.getOutput(), () -> {
            int i = this.guiLeft;
            int j = this.guiTop;
