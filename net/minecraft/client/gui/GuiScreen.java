...
import today.snowstorm.client.events.MouseClickEvent;
import today.snowstorm.client.events.MouseMoveEvent;
import today.snowstorm.client.events.MouseReleaseEvent;
...
public abstract class GuiScreen extends Gui implements GuiYesNoCallback
{
    ...
    {
        // Client: probably wont reimplement this :/
        //DrawScreenEvent e = new DrawScreenEvent(mouseX, mouseY, partialTicks);
    ...
    {
        MouseClickEvent e = new MouseClickEvent(mouseX, mouseY, mouseButton);
        e.setType(EventType.PRE);
        Snowstorm.INSTANCE.getEventBus().call(e);
    ...
    {
        MouseReleaseEvent e = new MouseReleaseEvent(mouseX, mouseY, state);
        e.setType(EventType.PRE);
        Snowstorm.INSTANCE.getEventBus().call(e);
    ...
    {
        MouseMoveEvent e = new MouseMoveEvent(mouseX, mouseY, clickedMouseButton);
        e.setType(EventType.PRE);
        Snowstorm.INSTANCE.getEventBus().call(e);
    }
