    ...
    public void doRender(T entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        if (!Reflector.RenderLivingEvent_Pre_Constructor.exists() || !Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Pre_Constructor, new Object[] {entity, this, Double.valueOf(x), Double.valueOf(y), Double.valueOf(z)}))
        {
            ...
            try
            {
                ...
                if(RotationUtils.useCustomPitch && entity == Wrapper.getMc().thePlayer) {
                    f7 = RotationUtils.getCustomPitch();
                }

                if(RotationUtils.useCustomYaw && entity == Wrapper.getMc().thePlayer) {
                    Wrapper.getMc().thePlayer.renderYawOffset = RotationUtils.getCustomYaw();
                    Wrapper.getMc().thePlayer.prevRenderYawOffset = RotationUtils.getCustomYaw();
                }
