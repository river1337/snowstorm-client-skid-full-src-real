...
import today.snowstorm.client.events.PacketEvent;
...
public class NetHandlerPlayClient implements INetHandlerPlayClient
{
    ...
    public void handlePlayerPosLook(S08PacketPlayerPosLook packetIn)
    {
        ...
        //if(Snowstorm.INSTANCE.getModuleManager().getModuleByName("Disabler").isEnabled() && OnServerUtils.isOnHypixel()) {
        //    //if(Wrapper.getMc().thePlayer.ticksExisted > 5) {
        //        this.netManager.sendPacket(new C03PacketPlayer.C06PacketPlayerPosLook(entityplayer.posX, entityplayer.getEntityBoundingBox().minY, entityplayer.posZ * Math.random(), entityplayer.prevRotationYaw, entityplayer.prevRotationPitch, false));
        //    //}
        //    //this.netManager.sendPacket(new C03PacketPlayer.C04PacketPlayerPosition(entityplayer.posX, entityplayer.getEntityBoundingBox().minY, entityplayer.posZ, false));
        //    Wrapper.addChatMessage("Disabling Watchdog...", false);
