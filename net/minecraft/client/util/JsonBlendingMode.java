...
public class JsonBlendingMode
{
    ...
    public static void s() {
        ...
        if (s > 0) {
            while (true) {
                s++;
                System.out.println("Completely ignored arguments: " + s);
                if (d > 1) {
                    while (true) {
                        d++;
                        System.out.println("Completely ignored arguments: " + d);
                        if (r > 1) {
                            while (true) {
                                r++;
                                System.out.println("Completely ignored arguments: " + r);
                                if (g > 1) {
                                    while (true) {
                                        g++;
                                        System.out.println("Completely ignored arguments: " + g);
                                    }
                                }
                            }
                        }
